...
namespace ZR.ServiceCore.Services
{
    ...
    public class GenTableColumnService : BaseService<GenTableColumn>, IGenTableColumnService
    {
        ...
        {
            return IDeleteable().Where(f => new long[] { tableId }.Contains(f.TableId)).ExecuteCommand();
        }
        ...
        public int DeleteGenTableColumn(long[] tableId)
        {
            return IDeleteable().Where(f => tableId.Contains(f.TableId)).ExecuteCommand();
        }
        ...
        {
            return IDeleteable().Where(f => f.TableName == tableName).ExecuteCommand();
        }
